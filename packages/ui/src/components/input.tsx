    ...
    <div className="group relative">
      <input
        ...
        className={cn(
          ...
          "aria-invalid:border-none aria-invalid:bg-[rgba(234,67,53,0.05)] aria-invalid:shadow-[inset_0px_1px_4px_rgba(234,67,53,0.6),inset_0px_-1px_4px_rgba(234,67,53,0.5)]",
          className
        )}
        {...props}
      />
