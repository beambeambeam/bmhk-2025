...
interface ScrollerProps extends VariantProps<typeof scrollerVariants>, React.ComponentPropsWithoutRef<"div"> {
  size?: number
  offset?: number
  asChild?: boolean
...
const ScrollButton = React.forwardRef<HTMLButtonElement, ScrollButtonProps>((props, forwardedRef) => {
