  ...
  return (
    <div {...props}>
      <div className="flex w-full items-center justify-center gap-4 md:gap-8">
        <div className="w-17 h-[1px] rounded-full bg-gradient-to-l from-[#FFFFFF] via-[#C9DDFA61] via-[38%] to-transparent md:w-[338px] lg:h-[2px] lg:w-[360px]" />
        ...
        <div className="w-17 h-[1px] rounded-full bg-gradient-to-r from-[#FFFFFF] via-[#C9DDFA61] via-[38%] to-transparent md:w-[338px] lg:h-[2px] lg:w-[360px]" />
      </div>
    </div>
  )
}
