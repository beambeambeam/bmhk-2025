          ...
          <ScrollArea className="flex min-h-0 flex-col gap-8 rounded-xl sm:gap-12" colorTheme="#9F83DC">
            ...
            <div className="flex flex-col gap-6">
              ...
              <ul className="text-body-1 list-disc pl-6">
                <li>
                  ข้อมูลส่วนบุคคล เช่น ชื่อ นามสกุล อายุ วัน/เดือน/ปีเกิด สัญชาติ เลขประจำตัวประชาชน เป็นต้น
                </li>
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-body-1">
                ...
                หากเราปฏิเสธคำขอเราจะแจ้งเหตุผลของการปฏิเสธให้คุณทราบผ่านช่องทางต่าง ๆ เช่น อีเมล โทรศัพท์
                เป็นต้น
              </p>
            </div>
            <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-body-1">
                ...
                safeguard) และด้านกายภาพ (physical safeguard)
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-body-1">
                ...
                เว็บไซต์ อีเมล โทรศัพท์ เป็นต้น
              </p>
            </div>
            <div className="flex flex-col gap-6">
