...
const CTA = ({ isMobile }: { isMobile?: boolean }) => {
  ...
  return (
    <button className="text-button-2 hidden h-full cursor-not-allowed rounded-full bg-[radial-gradient(ellipse_99.36%_78.93%_at_50.23%_99.36%,_rgba(198,_60,_81,_0.80)_9%,_rgba(198,_60,_81,_0.32)_100%)] px-10 py-2.5 text-white shadow-[0px_0px_20px_rgba(0,0,0,0.25),inset_-1px_-1px_30px_rgba(93,47,60,0.6)] lg:block">
      ยังไม่เปิดรับสมัคร
    </button>
  )
}
...
export default function Navbar() {
  ...
  return (
    <div className="md:px-15 z-50 w-full px-6 lg:px-20 2xl:px-40">
